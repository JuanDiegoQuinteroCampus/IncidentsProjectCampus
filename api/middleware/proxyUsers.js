...
const middlewareParamUsers = Router();

proxyUsers.use(async (req, res, next) => {
  try {
    const data = plainToClass(UsersDTO, req.body, { excludeExtraneousValues: true });
...
middlewareParamUsers.use(parametro, (req, res, next) => {
